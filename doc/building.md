...
Builds NEBULA to be a consensus-only low memory node. Data and fields not
...
e.g.:
    ...
    make -j$(sysctl -n hw.logicalcpu) NEBULA

This will only build `NEBULA`.
