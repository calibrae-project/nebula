...
/**
 * The CALIBRAE_DEFINE_PLUGIN() macro will define a steemit::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

CALIBRAE_DEFINE_PLUGIN( hello_api, steemit::example_plugin::hello_api_plugin )
