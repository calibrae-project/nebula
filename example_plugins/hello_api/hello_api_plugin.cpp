...
namespace calibrae { namespace example_plugin {

class hello_api_plugin : public calibrae::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( calibrae::app::application* app );
...
{
   public:
      hello_api_api( const calibrae::app::api_context& ctx );
...
FC_API( calibrae::example_plugin::hello_api_api,
   (get_message)
   )

namespace calibrae { namespace example_plugin {

hello_api_plugin::hello_api_plugin( calibrae::app::application* app ) : calibrae::app::plugin(app) {}
...
hello_api_api::hello_api_api( const calibrae::app::api_context& ctx ) : _app(ctx.app) {}
...
/**
 * The CALIBRAE_DEFINE_PLUGIN() macro will define a calibrae::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

CALIBRAE_DEFINE_PLUGIN( hello_api, calibrae::example_plugin::hello_api_plugin )
