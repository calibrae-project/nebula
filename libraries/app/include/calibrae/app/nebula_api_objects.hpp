...
struct comment_api_obj
{
   comment_api_obj( const chain::comment_object& o ):
      ...
      percent_nebula_dollars( o.percent_nebula_dollars ),
   ...
   uint16_t          percent_nebula_dollars = 0;
...
struct account_api_obj
{
   account_api_obj( const chain::account_object& a, const chain::database& db ) :
      ...
      reward_nebula_balance( a.reward_nebula_balance ),
...
FC_REFLECT( calibrae::app::comment_api_obj,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_nebula_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( calibrae::app::account_api_obj,
             ...
             (reward_sbd_balance)(reward_nebula_balance)(reward_vesting_balance)(reward_vesting_steem)
...
FC_REFLECT( calibrae::app::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( calibrae::app::account_recovery_request_api_obj,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( calibrae::app::savings_withdraw_api_obj,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( calibrae::app::feed_history_api_obj,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( calibrae::app::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( calibrae::app::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( calibrae::app::signed_block_api_obj, (calibrae::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( calibrae::app::dynamic_global_property_api_obj, (calibrae::chain::dynamic_global_property_object),
