...
namespace calibrae { namespace chain {
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         account_name_type reset_account = CALIBRAE_NULL_ACCOUNT;
         ...
         bool              can_vote = true;
         uint16_t          voting_power = CALIBRAE_100_PERCENT;   ///< current voting power of this account, it falls after every vote
          ...
          *  CALIBRAE_MIN_COMPOUNDING_INTERVAL_SECONDS has past since sbd_last_interest_payment then
         ...
         fc::array<share_type, CALIBRAE_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( CALIBRAE_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
...
FC_REFLECT( calibrae::chain::account_object,
...
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::account_object, calibrae::chain::account_index )

FC_REFLECT( calibrae::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::account_authority_object, calibrae::chain::account_authority_index )

FC_REFLECT( calibrae::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::vesting_delegation_object, calibrae::chain::vesting_delegation_index )

FC_REFLECT( calibrae::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::vesting_delegation_expiration_object, calibrae::chain::vesting_delegation_expiration_index )

FC_REFLECT( calibrae::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::owner_authority_history_object, calibrae::chain::owner_authority_history_index )

FC_REFLECT( calibrae::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::account_recovery_request_object, calibrae::chain::account_recovery_request_index )

FC_REFLECT( calibrae::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::change_recovery_account_request_object, calibrae::chain::change_recovery_account_request_index )
