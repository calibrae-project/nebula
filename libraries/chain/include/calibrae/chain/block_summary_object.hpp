...
FC_REFLECT( calibrae::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::block_summary_object, calibrae::chain::block_summary_index )
