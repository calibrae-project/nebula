...
FC_REFLECT( calibrae::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::comment_object, calibrae::chain::comment_index )

FC_REFLECT( calibrae::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::comment_vote_object, calibrae::chain::comment_vote_index )
