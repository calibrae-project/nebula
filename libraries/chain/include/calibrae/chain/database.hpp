...
#include <calibrae/chain/node_property_object.hpp>
#include <calibrae/chain/fork_database.hpp>
...
namespace calibrae { namespace chain {
   ...
   class database : public chainbase::database
   {
      public:
          ...
          */
         void open( const fc::path& data_dir, const fc::path& shared_mem_dir, uint64_t initial_supply = CALIBRAE_INIT_SUPPLY, uint64_t shared_file_size = 0, uint32_t chainbase_flags = 0 );
          ...
          *
          * Passing slot_num == 0 returns CALIBRAE_NULL_WITNESS
          */
         ...
         void init_schema();
         void init_genesis(uint64_t initial_supply = CALIBRAE_INIT_SUPPLY );
   ...
   protected:
      ...
      private:
         ...
         fc::time_point_sec            _hardfork_times[ CALIBRAE_NUM_HARDFORKS + 1 ];
         protocol::hardfork_version    _hardfork_versions[ CALIBRAE_NUM_HARDFORKS + 1 ];
