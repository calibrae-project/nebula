...
FC_REFLECT( calibrae::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( calibrae::chain::transaction_object, calibrae::chain::transaction_index )
