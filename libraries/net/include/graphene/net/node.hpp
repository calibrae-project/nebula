  ...
  struct message_propagation_data
  {
   ...
   class node : public std::enable_shared_from_this<node>
   {
      public:
        ...
        message_propagation_data get_transaction_propagation_data(const calibrae::protocol::transaction_id_type& transaction_id);
        message_propagation_data get_block_propagation_data(const calibrae::protocol::block_id_type& block_id);
