#include <calibrae/account_by_key/account_by_key_plugin.hpp>
...
struct post_operation_visitor
{
   ...
   {
      if( op.hardfork_id == CALIBRAE_HARDFORK_0_9 )
      {
...
account_by_key_plugin::account_by_key_plugin( calibrae::app::application* app )
...
CALIBRAE_DEFINE_PLUGIN( account_by_key, calibrae::account_by_key::account_by_key_plugin )
