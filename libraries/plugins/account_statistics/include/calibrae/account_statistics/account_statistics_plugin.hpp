...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_nebula_value = 0;     ///< STEEM Value of author rewards
   ...
   share_type           curation_rewards_nebula_value = 0;         ///< STEEM Value of curation rewards
   ...
   share_type           nebula_sent = 0;                           ///< STEEM sent from this account
   share_type           nebula_received = 0;                       ///< STEEM received by this account
   ...
   share_type           nebula_vested = 0;                         ///< STEEM vested by the account
   ...
   share_type           nebula_received_from_withdrawls = 0;       ///< STEEM received from this account's vesting withdrawals
   share_type           nebula_received_from_routes = 0;           ///< STEEM received from another account's vesting withdrawals
   ...
   share_type           nebula_converted = 0;                      ///< Amount of STEEM that was converted
   ...
   share_type           limit_order_nebula_paid = 0;               ///< STEEM paid by limit orders
   share_type           limit_order_nebula_received = 0;           ///< STEEM received from limit orders
...
class account_statistics_plugin : public calibrae::app::plugin
{
   public:
...
FC_REFLECT( calibrae::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
   ...
   (vests_withdrawn)
   (nebula_received_from_withdrawls)
   (nebula_received_from_routes)
   ...
   (limit_order_nebula_paid)
   (limit_order_nebula_received)
   (limit_order_sbd_paid)
   (limit_order_sbd_received)
   (total_pow)
   (estimated_hashpower)
)
//SET_INDEX_TYPE( calibrae::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   calibrae::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
