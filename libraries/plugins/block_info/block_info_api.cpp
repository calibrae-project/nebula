...
#include <calibrae/plugins/block_info/block_info_api.hpp>
#include <calibrae/plugins/block_info/block_info_plugin.hpp>
...
{
   public:
      block_info_api_impl( calibrae::app::application& _app );

      std::shared_ptr< calibrae::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( calibrae::app::application& _app ) : app( _app )
{}

std::shared_ptr< calibrae::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const calibrae::app::api_context& ctx )
{
