...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( calibrae::app::application& app )
            :_app( app ) {}
...
blockchain_statistics_api::blockchain_statistics_api( const calibrae::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->nebula_transferred                      += b.nebula_transferred;
   ...
   this->nebula_vested                           += b.nebula_vested;
   ...
   this->nebula_converted                        += b.nebula_converted;
