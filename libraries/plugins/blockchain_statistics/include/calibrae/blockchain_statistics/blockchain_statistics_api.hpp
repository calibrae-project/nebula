...
#include <calibrae/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
namespace calibrae { namespace blockchain_statistics {
...
struct statistics
{
   ...
   share_type           nebula_transferred = 0;                       ///< STEEM transferred from account to account
   ...
   share_type           nebula_vested = 0;                            ///< Ammount of STEEM vested
...
{
   public:
      blockchain_statistics_api( const calibrae::app::api_context& ctx );
...
} } // calibrae::blockchain_statistics

FC_REFLECT( calibrae::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( calibrae::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
