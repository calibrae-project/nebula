...
)
{
   ...
   calibrae::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   while( produced < count )
   {
      ...
      calibrae::chain::public_key_type scheduled_key = scheduled_witness.signing_key;
      if( debug_key != "" )
      {
...
CALIBRAE_DEFINE_PLUGIN( debug_node, calibrae::plugin::debug_node::debug_node_plugin )
