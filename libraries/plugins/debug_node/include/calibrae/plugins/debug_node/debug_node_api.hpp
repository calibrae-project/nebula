...
{
   public:
      debug_node_api( const calibrae::app::api_context& ctx );
       ...
       */
      // not implemented
      //void debug_push_block( calibrae::chain::signed_block& block );
...
FC_REFLECT( calibrae::plugin::debug_node::get_dev_key_args,
   (name)
   )

FC_REFLECT( calibrae::plugin::debug_node::get_dev_key_result,
   (private_key)
   (public_key)
   )

FC_REFLECT( calibrae::plugin::debug_node::debug_mine_args,
   (worker_account)
   (props)
   )

FC_REFLECT( calibrae::plugin::debug_node::debug_mine_result,
   )

FC_API(calibrae::plugin::debug_node::debug_node_api,
       (debug_push_blocks)
