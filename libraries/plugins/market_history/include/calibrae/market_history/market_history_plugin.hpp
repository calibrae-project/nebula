...
class market_history_plugin : public calibrae::app::plugin
{
   public:
...
FC_REFLECT( calibrae::market_history::bucket_object,
                     (id)
                     (open)(seconds)
                     (high_steem)(high_sbd)
                     (low_steem)(low_sbd)
...
CHAINBASE_SET_INDEX_TYPE( calibrae::market_history::bucket_object, calibrae::market_history::bucket_index )

FC_REFLECT( calibrae::market_history::order_history_object,
                     (id)
                     (time)
                     (op) )
CHAINBASE_SET_INDEX_TYPE( calibrae::market_history::order_history_object, calibrae::market_history::order_history_index )
