...
struct private_message_operation : public calibrae::protocol::base_operation
{
...
FC_REFLECT( calibrae::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

DECLARE_OPERATION_TYPE( calibrae::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( calibrae::private_message::private_message_plugin_operation )
