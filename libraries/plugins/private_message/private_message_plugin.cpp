#include <calibrae/private_message/private_message_evaluators.hpp>
...
class private_message_plugin_impl
{
   public:
      ...
      std::shared_ptr< generic_custom_operation_interpreter< calibrae::private_message::private_message_plugin_operation > >   _custom_operation_interpreter;
...
private_message_plugin_impl::private_message_plugin_impl( private_message_plugin& _plugin )
   : _self( _plugin )
{
   _custom_operation_interpreter = std::make_shared< generic_custom_operation_interpreter< calibrae::private_message::private_message_plugin_operation > >( database() );
...
CALIBRAE_DEFINE_PLUGIN( private_message, calibrae::private_message::private_message_plugin )

DEFINE_OPERATION_TYPE( calibrae::private_message::private_message_plugin_operation )
