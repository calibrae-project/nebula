...
namespace calibrae { namespace protocol {
   ...
   {
      FC_ASSERT( permlink.size() < CALIBRAE_MAX_PERMLINK_LENGTH, "permlink is too long" );
   ...
   struct comment_options_operation : public base_operation
   {
      ...
      uint16_t          percent_nebula_dollars  = CALIBRAE_100_PERCENT; /// the percent of Steem Dollars to key, unkept amounts will be received as Steem Power
   ...
   struct chain_properties
   {
      ...
      asset             account_creation_fee =
         asset( CALIBRAE_MIN_ACCOUNT_CREATION_FEE, NECTAR_SYMBOL );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = CALIBRAE_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t          sbd_interest_rate  = CALIBRAE_DEFAULT_SBD_INTEREST_RATE;

      void validate()const
      {
         FC_ASSERT( account_creation_fee.amount >= CALIBRAE_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= CALIBRAE_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( sbd_interest_rate >= 0 );
         FC_ASSERT( sbd_interest_rate <= CALIBRAE_100_PERCENT );
      }
   };
    ...
    *  The funds are deposited after CALIBRAE_CONVERSION_DELAY
    */
    ...
    * CALIBRAE_MAX_WITNESSES blocks of the head block (1 round) and the
...
FC_REFLECT( calibrae::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( calibrae::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( calibrae::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( calibrae::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( calibrae::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( calibrae::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( calibrae::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( calibrae::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( calibrae::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( calibrae::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( calibrae::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( calibrae::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( calibrae::protocol::chain_properties, (account_creation_fee)(maximum_block_size)(sbd_interest_rate) );

FC_REFLECT_TYPENAME( calibrae::protocol::pow2_work )
FC_REFLECT( calibrae::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( calibrae::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( calibrae::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( calibrae::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( calibrae::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( calibrae::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( calibrae::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( calibrae::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( calibrae::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( calibrae::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( calibrae::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( calibrae::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( calibrae::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( calibrae::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( calibrae::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( calibrae::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( calibrae::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( calibrae::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( calibrae::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( calibrae::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( calibrae::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( calibrae::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( calibrae::protocol::comment_payout_beneficiaries, (beneficiaries) )
FC_REFLECT_TYPENAME( calibrae::protocol::comment_options_extension )
FC_REFLECT( calibrae::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_nebula_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( calibrae::protocol::escrow_transfer_operation, (from)(to)(sbd_amount)(nebula_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( calibrae::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( calibrae::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( calibrae::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(nebula_amount) );
FC_REFLECT( calibrae::protocol::challenge_authority_operation, (challenger)(challenged)(require_owner) );
FC_REFLECT( calibrae::protocol::prove_authority_operation, (challenged)(require_owner) );
FC_REFLECT( calibrae::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( calibrae::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( calibrae::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( calibrae::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( calibrae::protocol::claim_reward_balance_operation, (account)(reward_steem)(reward_sbd)(reward_vests) )
FC_REFLECT( calibrae::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
