...
FC_REFLECT( calibrae::protocol::author_reward_operation, (author)(permlink)(sbd_payout)(nebula_payout)(vesting_payout) )
FC_REFLECT( calibrae::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( calibrae::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( calibrae::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( calibrae::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( calibrae::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( calibrae::protocol::fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( calibrae::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( calibrae::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( calibrae::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( calibrae::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( calibrae::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( calibrae::protocol::return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( calibrae::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(reward) )
FC_REFLECT( calibrae::protocol::producer_reward_operation, (producer)(vesting_shares) )
