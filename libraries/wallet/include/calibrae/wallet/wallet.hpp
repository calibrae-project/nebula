...
using calibrae::app::discussion;
using namespace calibrae::private_message;
...
class wallet_api
{
   public:
       ...
       *
       *  @param creator The account creating the new account
       *  @param nebula_fee The amount of the fee to be paid with STEEM
       *  @param delegated_vests The amount of the fee to be paid with delegation
       *  @param new_account_name The name of the new account
       *  @param json_meta JSON Metadata associated with the new account
       *  @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction create_account_delegated( string creator, asset nebula_fee, asset delegated_vests, string new_account_name, string json_meta, bool broadcast );
       ...
       * @param nebula_amount The amount of STEEM to transfer
       ...
       * @param nebula_amount The amount of STEEM that will be released
       * @param broadcast true if you wish to broadcast the transaction
       */
...
FC_REFLECT( calibrae::wallet::wallet_data,
            (cipher_keys)
            (ws_server)
            (ws_user)
            (ws_password)
...
FC_REFLECT( calibrae::wallet::brain_key_info, (brain_priv_key)(wif_priv_key) (pub_key))

FC_REFLECT( calibrae::wallet::plain_keys, (checksum)(keys) )

FC_REFLECT_ENUM( calibrae::wallet::authority_type, (owner)(active)(posting) )

FC_API( calibrae::wallet::wallet_api,
        /// wallet api
        (help)(gethelp)
...
FC_REFLECT( calibrae::wallet::memo_data, (from)(to)(nonce)(check)(encrypted) )
