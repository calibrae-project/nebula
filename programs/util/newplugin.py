...
target_link_libraries( {plugin_provider}_{plugin_name} calibrae_app calibrae_chain calibrae_protocol )
...
CALIBRAE_DEFINE_PLUGIN( {plugin_name}, {plugin_provider}::plugin::{plugin_name}::{plugin_name}_plugin )
""",
}
