...
/*
namespace calibrae { namespace plugin_tests {
...
} } // calibrae::plugin_tests

CALIBRAE_DEFINE_PLUGIN( test, calibrae::plugin_tests::test_plugin )

FC_REFLECT( calibrae::plugin_tests::test_a_operation, (account) )
FC_REFLECT( calibrae::plugin_tests::test_b_operation, (account) )

DECLARE_OPERATION_TYPE( calibrae::plugin_tests::test_op );
FC_REFLECT_TYPENAME( calibrae::plugin_tests::test_op );
DEFINE_OPERATION_TYPE( calibrae::plugin_tests::test_op );
*/
